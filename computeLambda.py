...
# CG variables taking the matrix lambda as an input.
#------------------------------------------------------------------------------
#                         Author: @DiegoDZ
#                         Date  : July 2017
...
nSteps      = 2000            #t=4 (r.u.).
nStepsModel = 1999            #time to compute the prediction of CG variables
...
def computeCGpredict(Lambda,V0):
    ...
    for j in range(nStepsModel):
       print datetime.datetime.now(), 'Computing CG(t) predicted. Step', str(j)
...
if theory == 1:
    ...
    if compute_Ct == 'y':
        ...
        c_rhorho = np.loadtxt('corr_rhorho.avgs.dat.2e3steps_t100')
        c_rhogz  = np.loadtxt('corr_rhogz.avgs.dat.2e3steps_t100')
        c_gzrho  = np.loadtxt('corr_gzrho.avgs.dat.2e3steps_t100')
        c_gzgz   = np.loadtxt('corr_gzgz.avgs.dat.2e3steps_t100')
        ...
        np.savetxt('Ct_2e3steps_t100-rhogzTh', Ct)
        np.savetxt('Ct_50steps_t100-rhogzTh', Ct[0:50,:])
        np.savetxt('C0_t100-rhogzTh', C0_stat)
    ...
    if compute_lambda == 'y':
        ...
        Ct     = np.loadtxt('Ct_50steps_t100-rhogzTh')
        C0     = np.loadtxt('C0_t100-rhogzTh')
    ...
    if compute_Ctpred == 'y':
        ...
        Ct                        = np.loadtxt('Ct_2e3steps_t100-rhogzTh')
        C0                        = np.loadtxt('C0_t100-rhogzTh')
...
#------------------------------------------------------------------------------
    ...
    if compute_Ct == 'y':
        ...
        c_gxgx = np.loadtxt('corr_gxgx.avgs.dat.2e3steps_t100')
        ...
        np.savetxt('Ct_2e3steps_t100-gxTh', Ct)
        np.savetxt('Ct_50steps_t100-gxTh', Ct[0:50,:])
        np.savetxt('C0_t100-gxTh', C0_stat)
    ...
    if compute_lambda == 'y':
        ...
        Ct     = np.loadtxt('Ct_50steps_t100-gxTh')
        C0     = np.loadtxt('C0_t100-gxTh')
        Lambda = computeLambda(Ct,C0)
    ...
    if compute_Ctpred == 'y':
        ...
        Ct                        = np.loadtxt('Ct_2e3steps_t100-gxTh')
        C0                        = np.loadtxt('C0_t100-gxTh')
...
#------------------------------------------------------------------------------
    ...
    if compute_Ct == 'y':
        ...
        c_rhorho = np.loadtxt('corr_rhorho.avgs.dat.2e3steps_t100')
        c_rhoe   = np.loadtxt('corr_rhoe.avgs.dat.2e3steps_t100')
        c_rhogz  = np.loadtxt('corr_rhogz.avgs.dat.2e3steps_t100')
        c_erho   = np.loadtxt('corr_erho.avgs.dat.2e3steps_t100')
        c_ee     = np.loadtxt('corr_ee.avgs.dat.2e3steps_t100')
        c_egz    = np.loadtxt('corr_egz.avgs.dat.2e3steps_t100')
        c_gzrho  = np.loadtxt('corr_gzrho.avgs.dat.2e3steps_t100')
        c_gze    = np.loadtxt('corr_gze.avgs.dat.2e3steps_t100')
        c_gzgz   = np.loadtxt('corr_gzgz.avgs.dat.2e3steps_t100')
        ...
        np.savetxt('Ct_2e3steps_t100-rhoegzTh', Ct)
        np.savetxt('Ct_50steps_t100-rhoegzTh', Ct[0:50,:])
        np.savetxt('C0_t100-rhoegzTh', C0_stat)
    ...
    if compute_lambda == 'y':
        ...
        Ct     = np.loadtxt('Ct_50steps_t100-rhoegzTh')
        C0     = np.loadtxt('C0_t100-rhoegzTh')
        Lambda = computeLambda(Ct,C0)
    ...
    if compute_Ctpred == 'y':
        ...
        Ct                        = np.loadtxt('Ct_2e3steps_t100-rhoegzTh')
        C0                        = np.loadtxt('C0_t100-rhoegzTh')
    ...
    if compute_CGpred == 'y':
        ...
        Lambda                    = np.loadtxt('Lambda-rhoegzTh')
        rho                       = np.loadtxt('mesoDensity.avg.dat.short')
        e                         = np.loadtxt('mesoEnergy.avg.dat.short')
        gz                        = np.loadtxt('mesoMomentum_z.avg.dat.short')

        V0       = np.hstack((rho[0,:], e[0,:], gz[0,:]))
        VPredict = computeCGpredict(Lambda, V0)
        np.savetxt('rhoPredict', VPredict[:, 0:nNodes])
        np.savetxt('ePredict', VPredict[:, nNodes:2*nNodes])
        np.savetxt('gzPredict', VPredict[:,2*nNodes:3*nNodes])
...
#------------------------------------------------------------------------------
    ...
    if compute_Ct == 'y':
        ...
        c_rhorho = np.loadtxt('corr_rhorho.avgs.dat.2e3steps_t100')
        c_rhoe   = np.loadtxt('corr_rhoe.avgs.dat.2e3steps_t100')
        c_rhogx  = np.loadtxt('corr_rhogx.avgs.dat.2e3steps_t100')
        c_rhogz  = np.loadtxt('corr_rhogz.avgs.dat.2e3steps_t100')
        c_erho   = np.loadtxt('corr_erho.avgs.dat.2e3steps_t100')
        c_ee     = np.loadtxt('corr_ee.avgs.dat.2e3steps_t100')
        c_egx    = np.loadtxt('corr_egx.avgs.dat.2e3steps_t100')
        c_egz    = np.loadtxt('corr_egz.avgs.dat.2e3steps_t100')
        c_gxrho  = np.loadtxt('corr_gxrho.avgs.dat.2e3steps_t100')
        c_gxe    = np.loadtxt('corr_gxe.avgs.dat.2e3steps_t100')
        c_gxgx   = np.loadtxt('corr_gxgx.avgs.dat.2e3steps_t100')
        c_gxgz   = np.loadtxt('corr_gxgz.avgs.dat.2e3steps_t100')
        c_gzrho  = np.loadtxt('corr_gzrho.avgs.dat.2e3steps_t100')
        c_gze    = np.loadtxt('corr_gze.avgs.dat.2e3steps_t100')
        c_gzgx   = np.loadtxt('corr_gzgx.avgs.dat.2e3steps_t100')
        c_gzgz   = np.loadtxt('corr_gzgz.avgs.dat.2e3steps_t100')
        ...
        np.savetxt('Ct_2e3steps_t100-rhoegxgzTh', Ct)
        np.savetxt('Ct_50steps_t100-rhoegxgzTh', Ct[0:50,:])
        np.savetxt('C0_t100-rhoegxgzTh', C0_stat)
    ...
    if compute_lambda == 'y':
        ...
        Ct     = np.loadtxt('Ct_50steps_t100-rhoegxgzTh')
        C0     = np.loadtxt('C0_t100-rhoegxgzTh')
        Lambda = computeLambda(Ct,C0)
    ...
    if compute_Ctpred == 'y':
        ...
        Ct                        = np.loadtxt('Ct_2e3steps_t100-rhoegxgzTh')
        C0                        = np.loadtxt('C0_t100-rhoegxgzTh')
...
#------------------------------------------------------------------------------
    ...
    if compute_Ct == 'y':
        ...
        np.savetxt('Ct_2e3steps_t100-eTh', Ct)
        np.savetxt('Ct_50steps_t100-eTh', Ct[0:50,:])
        np.savetxt('C0_t100-eTh', C0_stat)
    ...
    if compute_lambda == 'y':
        ...
        Ct     = np.loadtxt('Ct_50steps_t100-eTh')
        C0     = np.loadtxt('C0_t100-eTh')
        Lambda = computeLambda(Ct,C0)
    ...
    if compute_Ctpred == 'y':
        ...
        Ct                        = np.loadtxt('Ct_2e3steps_t100-eTh')
        C0                        = np.loadtxt('C0_t100-eTh')
