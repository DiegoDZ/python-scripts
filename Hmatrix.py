...
c01 = np.loadtxt('covariance_densityMacroInternalEnergy')
#c02 = np.loadtxt('covariance_densityCenterOfMassUpperWall')
#c03 = np.loadtxt('covariance_densityCenterOfMassLowerWall')
c02=  np.loadtxt('covariance_densityMacroInternalEnergyWall')
...
c12 = np.loadtxt('covariance_internalEnergyMacroInternalEnergyWall')
...
c20 = np.loadtxt('covariance_macroInternalEnergyWallDensity')
#c51 = np.loadtxt('covariance_macroInternalEnergyLowerWallInternalEnergy')
c21 = np.loadtxt('covariance_macroInternalEnergyWallInternalEnergy')
...
c22 = np.loadtxt('covariance_macroInternalEnergyWall')
...
internalEnergyFluid = np.asmatrix(np.loadtxt('mesoInternalEnergy_fluid'))
...
internalEnergyWall = np.asmatrix(np.loadtxt('macroInternalEnergy_wall'))
...
internalEnergyrWall = internalEnergyWall - internalEnergyWall[:,number_snapshots-1]
...
"""
betaFluid_term_densityFluid = np.zeros((number_snapshots, nodes))
betaFluid_term_internalEnergyFluid = np.zeros((number_snapshots, nodes))
for t in range(0, number_snapshots):
    for i in range(nodes, 2*nodes):
        betaFluid_term_densityFluid[t,i-nodes] = np.sum(H[i,0:nodes] * densityFluid[t,:].T)
        betaFluid_term_internalEnergyFluid[t,i-nodes] = np.sum(H[i, nodes:2*nodes] * internalEnergyFluid[t,:].T)
betaFluid_term_internalEnergyWall = np.zeros((number_snapshots, nodes))
for i in range(nodes, 2*nodes):
    betaFluid_term_internalEnergyWall[:,i-nodes] = H[i, 2*nodes+2] * internalEnergyWall
# Sum terms
betaFluid = betaFluid_term_internalEnergyFluid + betaFluid_term_internalEnergyWall
...
betaWall_term_internalEnergyFluid = np.zeros(number_snapshots)
for t in range(0, number_snapshots):
     betaWall_term_densityFluid[t] = np.sum(H[2*nodes+3, 0:nodes] * densityFluid[t,:].T)
     betaWall_term_internalEnergyFluid[t] = np.sum(H[2*nodes+3, nodes:2*nodes] * internalEnergyFluid[t,:].T)
betaWall_term_internalEnergyWall = H[2*nodes+3, 2*nodes+2] * internalEnergyWall
# Sum terms
betaWall = betaWall_term_densityFluid + betaWall_term_internalEnergyFluid + betaWall_term_internalEnergyWall
betaWall = np.asmatrix(betaWall)
betaWall_inverse = 1/betaWall


###
# Compute the term betaFinal as beta - betaWall
###
betaFinal = betaFluid - betaWall.T
...
"""
#np.savetxt('betaFluid_term_densityFluid', betaFluid_term_densityFluid)
np.savetxt('betaFluid_term_internalEnergyFluid', betaFluid_term_internalEnergyFluid)
...
np.savetxt('betaFluid_term_internalEnergyWall', betaFluid_term_internalEnergyWall)
"""
...
"""
np.savetxt('betaWall_term_internalEnergyWall', betaWall_term_internalEnergyWall.T)
np.savetxt('betaWall_term_internalEnergyFluid', betaWall_term_internalEnergyFluid)
...
np.savetxt('betaWall_inverse', betaWall_inverse.T)
